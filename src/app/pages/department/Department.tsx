...
export function DepartmentPage() {
    return (
        <>
            <PageTitle breadcrumbs={[]}>Départements</PageTitle>
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <div className="card-px text-center pt-15 pb-15">
                        ...
                        <p className="text-gray-400 fs-4 fw-bold py-7">Aucun département ajouté veuillez en créer un nouveau.</p>

                        <a href="#" className="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target"> <i className="fas fa-plus-circle fs-1x"></i> Ajouter un département</a>
                    ...
                    <div className={`card`}>
                        ...
                        <div className='card-header border-0 pt-5'>
                            <h3 className='card-title align-items-start flex-column'>
                                <span className='card-label fw-bolder fs-3 mb-1'>Liste des départements</span>
                                ...
                                <table className='table align-middle gs-0 gy-4'>
                                    ...
                                    <thead>
                                        <tr className='fw-bolder text-muted bg-light'>
                                            ...
                                            <th className='ps-4 min-w-325px rounded-start'>Nom Direction </th>
                ...
                <div className='modal-dialog modal-dialog-centered mw-900px'>
                    <div className='modal-content'>
                        ...
                        <div className='modal-body py-lg-10 px-lg-10'>
                            ...
                            <div className="row">
                                <div className="mb-10 col-lg-6">
                                    <label className="form-label">Nbre Par équipe</label>
                                    <input
                                        type="text"
