            ...
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <div className="card-px text-center pt-15 pb-15">
                        ...
                        <p className="text-gray-400 fs-4 fw-bold py-7">Aucune société ajoutée veuillez en créer une nouvelle.</p>

                        <a href="#" className="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target"> <i className="fas fa-plus-circle fs-1x"></i> Ajouter une société</a>

                    </div>

                    <div className="text-center pb-10 px-4">
                        <img src="/media/svg/perso/new_entry.svg" alt="" className="mw-100 h-200px h-sm-325px" />
                    </div>
                    ...
                    <div className={`card`}>
                        ...
                        <div className='card-header border-0 pt-5'>
                            <h3 className='card-title align-items-start flex-column'>
                                <span className='card-label fw-bolder fs-3 mb-1'>Liste des sociétés</span>
